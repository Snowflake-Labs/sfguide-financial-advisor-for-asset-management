...
CREATE OR REPLACE STAGE FINANCIAL_ADVISOR_DEMO_DB.analytics.FINANCIAL_ADVISOR_STAGE
    ...
    COMMENT = 'Stage for PDFs';

CREATE OR REPLACE STAGE FINANCIAL_ADVISOR_DEMO_DB.analytics.SEMANTIC_MODELS_STAGE
    DIRECTORY = (ENABLE = TRUE)
    ENCRYPTION = (TYPE = 'SNOWFLAKE_SSE')
    COMMENT = 'Stage for semantic models';
...
GRANT READ ON STAGE FINANCIAL_ADVISOR_DEMO_DB.analytics.SEMANTIC_MODELS_STAGE TO ROLE FINANCIAL_ADVISOR_ROLE;
GRANT WRITE ON STAGE FINANCIAL_ADVISOR_DEMO_DB.analytics.SEMANTIC_MODELS_STAGE TO ROLE FINANCIAL_ADVISOR_ROLE;
...
GRANT CREATE SNOWFLAKE INTELLIGENCE ON ACCOUNT TO ROLE FINANCIAL_ADVISOR_ROLE;
GRANT USAGE ON SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT TO ROLE FINANCIAL_ADVISOR_ROLE;
GRANT MODIFY ON SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT TO ROLE FINANCIAL_ADVISOR_ROLE;
GRANT USAGE ON SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT TO ROLE PUBLIC;
GRANT CREATE AGENT ON SCHEMA FINANCIAL_ADVISOR_DEMO_DB.analytics TO ROLE FINANCIAL_ADVISOR_ROLE;
